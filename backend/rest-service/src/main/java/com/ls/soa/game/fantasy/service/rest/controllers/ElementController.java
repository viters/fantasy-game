...
public class ElementController extends Controller {
    ...
    @POST
    @Secured
    public Response create(ElementDTO elementDTO, @Context SecurityContext securityContext, @Context HttpServletRequest request) throws UserNotFoundException, InvalidTokenException, InsufficientPermissionsException {
        String token = securityContext.getUserPrincipal().getName();
    ...
    @PUT
    @Secured
    public Response update(ElementDTO elementDTO, @Context SecurityContext securityContext, @Context HttpServletRequest request) throws InvalidTokenException, InsufficientPermissionsException, UserNotFoundException, ElementNotFoundException {
        String token = securityContext.getUserPrincipal().getName();
    ...
    public Response update(@PathParam("id") String id, @Context SecurityContext securityContext, @Context HttpServletRequest request) throws InvalidTokenException, InsufficientPermissionsException {
        ...
        try {
            ...
            return buildErrorResponse(ErrorType.NO_SUCH_ELEMENT, request.getLocale());
        }
    }
}